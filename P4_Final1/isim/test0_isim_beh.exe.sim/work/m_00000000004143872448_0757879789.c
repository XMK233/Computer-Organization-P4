...
LAB68:    memcpy(t149, t190, 8);

LAB69:    goto LAB51;

LAB52:    xsi_vlog_unsigned_bit_combine(t129, 32, t144, 32, t149, 32);
    goto LAB56;
...
LAB61:    t163 = ((char*)((ng2)));
    ...
    *((unsigned int *)t164) = (t172 & 67108863U);
    t173 = *((unsigned int *)t165);
    *((unsigned int *)t165) = (t173 & 67108863U);
    t175 = (t0 + 600U);
    t176 = *((char **)t175);
    memset(t174, 0, 8);
    t175 = (t174 + 4);
    ...
    *((unsigned int *)t175) = (t183 & 15U);
    xsi_vlogtype_concat(t162, 32, 32, 3U, t174, 4, t164, 26, t163, 2);
    goto LAB62;
...
LAB63:    t188 = (t0 + 600U);
    ...
    t188 = ((char*)((ng3)));
    memset(t190, 0, 8);
    xsi_vlog_unsigned_add(t190, 32, t189, 32, t188, 32);
    goto LAB64;

LAB65:    xsi_vlog_unsigned_bit_combine(t149, 32, t162, 32, t190, 32);
    goto LAB69;

LAB67:    memcpy(t149, t162, 8);
    goto LAB69;
...
extern void work_m_00000000004143872448_0757879789_init()
{
	static char *pe[] = {(void *)Cont_34_0,(void *)Cont_38_1};
	xsi_register_didat("work_m_00000000004143872448_0757879789", "isim/test0_isim_beh.exe.sim/work/m_00000000004143872448_0757879789.didat");
